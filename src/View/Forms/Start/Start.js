                    ...
                    value == "2" ? (
                        <>
                            {/* <div className="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="otpRadio" name="proceed" value="otp" defaultChecked={false} disabled className="custom-control-input" />
                                <label className="custom-control-label" htmlFor="otpRadio">
                                    <Text tid="otp_kyc" />
                                </label>
                            </div> */}
                            <div className="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="otpRadio1" name="proceed" value="otp" onChange={this.selectProcess} defaultChecked={true} className="custom-control-input" />
                        ...
                        <>
                            <div className="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="otpRadio" name="proceed" value="otp" onChange={this.selectProcess}  className="custom-control-input" />
                                <label className="custom-control-label" htmlFor="otpRadio">
                                    <Text tid="otp_kyc" />
                                </label>
                            </div>
