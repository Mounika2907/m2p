...
{/* <div className="row justify-content-center">
                    <div className="col-md-5 p-0">
                        <div className="instructions sr1">
                            <div className="reschedule">
                                {scheduleDetails?.time ?
                                    <p className="small text-danger text-center">
                                        <span className="text-primary">Schedule Datails: </span>
                                        {scheduleDetails.sdate} ({scheduleDetails.time})</p>
                                    : null}
                            ...
                            <div className="text-center mt-3">
                                <button type="button" className="custom-btn" data-toggle="modal" data-target="#info">
                                    Change language
                                </button>
                            </div>
                    ...
                    <div className="col-md-5 p-0">
                        <div className="instructions sr1 border-right-0">
                            <div className="reschedule">
                                ...
                                <form className="reschedule-form">
                                    <div className="form-group">
                                        <label className="reschedule-label">Select new date for video call session</label>
                                        <input type="date"
                                            name="sdate"
                                            min={this.formateDate(calenderDetails.sfdate)} max={this.formateDate(calenderDetails.stdate)}
                                            onChange={this.handleChange}
                                            className="form-control reschedule-inp"
                                            required />
                                    </div>
                                    <div className="form-group">
                                        <label className="reschedule-label">Select available time slots</label>
                                        <div className="position-relative">
                                            ...
                                            <select defaultValue={'DEFAULT'}
                                                ...
                                                className="form-control reschedule-inp"
                                                required>
                                                {calenderDetails ? calenderDetails?.stimes?.map((res, index) => (
                            ...
                            <div className="text-center mt-3">
                                <button type="button" onClick={this.createSchedule} className="custom-btn">
                                    Confirm
                                </button>
                            </div>
                            <p className="reschedule-note">
