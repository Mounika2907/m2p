const en = {
    title: "Syntizen Bank User Onboarding Process",
    ...
    ans2: "The Offline KYC is a mode of KYC which eliminates the need for the user to provide photo copy of Aadhaar card and instead user can download the KYC XML/QR Code and provide the same to Syntizen to perform his/her KYC. Syntizen wiil verify the KYC details shared by the user. The KYC details is in machine readable XML which is digitally signed by UIDAI allowing agency to verify its authenticity and detect any tampering.",
    // =============POPUP===============
    ...
    end_status11321: "Thank You for completing the Video-KYC process with Syntizen Bank. We are waiting for the Approval from Banker and Auditor for your V-CIP ID.  The final status for your V-CIP ID will be shared to you Via SMS on your registered mobile number. You can revisit to the same web-link anytime to check the updated status. ",
