...
import {SytledBUTTON, SytledH2} from "../../../hoc/style_component"
const $ = window.$;
    ...
    render() {
        ...
        return (
            <Aux>
                    ...
                    /> : (
                            <div className="col-md-6">
                                <div className="details sr1 block-disabled">
                                    <SytledH2 color={this.props.pincodeRdr.color} className="info-title">
                                    ...
                                    <div className="row m-0">
                                        <div className="col-md-12 p-0">
                                            ...
                                            <div className="text-center mt-3">
                                                <SytledBUTTON color={this.props.pincodeRdr.color} type="button" disabled className="custom-btn">
                                                    <Text tid="proceed" />
                                                </SytledBUTTON>
                                            </div>
                                        </div>
                ...
                <SytledBUTTON color={this.props.pincodeRdr.color} onClick={this.back} disabled={this.state.backDisbale} className="custom-btn">
                    <Text tid="back" />
                </SytledBUTTON>
            </Aux>
        )
