...
// import DigiLockerCmp from '../../../Component/Forms/AadharCmp/DigiLockerCmp';
import DigiLockerCmp from '../../../Component/Forms/AadharCmp/DigiLockerCmp';
...
class DigiLocker extends Component {
    ...
    componentDidUpdate() {
        const digi = this.props.PanRdr?.DigiLockerStatusReducker
        if (Object.keys(digi).length > 0) {
            if (digi.status == 'Success') {
                this.state.closeWindowState.close();
    ...
    handleProceed = () => {
        if (this.props.PanRdr.DigiLockerStatusReducker.status == 'Success') {
            $('#xmlInfo').modal('hide');
    ...
    fetchDigiLocker = (e) => {
        ...
        // console.log(this.props.PanRdr?.DigiLockerRequestReducker, 'asfd')
        var closeWindow = window.open(this.props.PanRdr?.DigiLockerRequestReducker?.url, "", "")
        if (!closeWindow || closeWindow.closed || typeof closeWindow.closed == 'undefined') {
            toast.error("Please allow Popup")
        }

        this.setState({
            closeWindowState: closeWindow
        })
    ...
    render() {
        ...
        return (
            <Aux>
                ...
                <div className="row justify-content-center w-100">
                    <div className="col-md-6 p-0">
                        <DigiLockerCmp
                            ...
                            newstate={this.state?.closeWindowState}
                        ...
                        <div className="modal-content">
                            <div className="modal-body">
                                <div className="instructions border-right-0">
                                    ...
                                    {this.props.PanRdr.DigiLockerStatusReducker ? (<div>
                                        <div className="w-75 mx-auto">

                                            <div className="text-center">
                                                <img src={this.props.PanRdr.DigiLockerStatusReducker.kycdetails?.pht ? `data:image/png;base64,${this.props.PanRdr.DigiLockerStatusReducker.kycdetails?.pht}` : null}
                                            ...
                                            <table className="table mx-auto">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Name</td>
                                                        <td>{this.props.PanRdr.DigiLockerStatusReducker.kycdetails?.name}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Gender</td>
                                                        <td>{this.props.PanRdr.DigiLockerStatusReducker.kycdetails?.gender}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>D.O.B</td>
                                                        <td>{this.props.PanRdr.DigiLockerStatusReducker.kycdetails?.dob}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Address</td>
                                                        <td>{this.props.PanRdr.DigiLockerStatusReducker.kycdetails?.address}</td>
                                                    </tr>
                                                    {/* <tr>
                ...
                <div className="modal fade" id="xmlFailedCase" data-backdrop="static" tabIndex={-1} role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered custom-model-adr" role="document">
                        <div className="modal-content">
                            <div className="modal-body">
                                <div className="instructions border-right-0">
                                    ...
                                    {this.props.PanRdr.DigiLockerStatusReducker ? (<div>
                                        ...
                                        <form>
                                            <div className="pb-3 text-center">
                                                <SytledBUTTON color={this.props.pincodeRdr.color} type="button" onClick={this.handleBackToStart} className="btn custom-btn">
                                                    <Text tid="proceed" />
                                                </SytledBUTTON>
                                            </div>
                                        </form>
                ...
                <div className="modal fade" id="tutorialmodal" data-backdrop="static" tabIndex={-1} role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered custom-model-adr" role="document">
                        <div className="modal-content">
                            <div className="modal-body">
                                <div className="instructions border-right-0">
                                    ...
                                    {/* {this.props.PanRdr.DigiLockerStatusReducker ? ( */}
                                    <div>
                                        <div className="w-75 mx-auto text-center">
                                        ...
                                        <form>
                                            <div className="pb-3 text-center">
                                                {/* <button type="button" onClick={this.handleBackToStart} className="btn custom-btn">
                                                    <Text tid="proceed" />
                                                </button> */}
...
export default connect(mapStateToProps, mapsDispatchToProps)(DigiLocker);
