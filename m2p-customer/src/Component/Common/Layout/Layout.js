...
import {SytledH1, SytledH5} from '../../../hoc/style_component';
        ...
        return (
            <Aux>
                ...
                <main className="user" id="menudiplsay">
                    ...
                    <SytledH1 color={this.props.pincodeRdr.color} className="title">
                        {/* <h1 className="title"> */}
                        {
                            `${clientname}`
                        }
                        {/* Bank User Onboarding Process */}
                        <Text tid="title" />
                    {/* </h1> */}
                    </SytledH1>
