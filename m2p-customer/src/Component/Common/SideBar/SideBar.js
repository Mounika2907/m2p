...
import {SytledH1} from '../../../hoc/style_component';
...
// `;
        ...
        const colorcode = sessionStorage.getItem("colorcode");
        ...
        return (
            <aside className="user-sidebar" id="menu">
               <SytledH1 color={this.props.pincodeRdr.color} className="sidebar-title">
                   {clientname} 
                   {/* <h2 className="sidebar-title"> */}
                    {/* {clientname ? clientname : "Syntizen"} */}
                    {/* Syntizen */}
                {/* </h2> */}
                </SytledH1>
