...
import { SytledBUTTON, SytledH2, Sytledth } from '../../../hoc/style_component';
                ...
                <div className="details">
                    ...
                    <div className="row m-0">
                        <div className="col-md-9 p-0">
                            <div className="table-responsive">
                                <table className="table info-data mb-0">
                                    <thead>
                                        <tr>
                                            <Sytledth color={props.color} scope="col" className="pl-0">Fields</Sytledth>
                                            <Sytledth color={props.color} scope="col" className="pl-0">
                                                <span>OCR Info</span>
                                                {/* <p className="photo-name">PHOTO</p> */}
                                            ...
                                            <img src={`data:image/png;base64,${props.panData.pht}`} className="mb-2" width="50px" height="50px" alt="no img" />
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                        ...
                        <div className="col-12">
                            <div className="text-center mt-3">
                                <SytledBUTTON color={props.color} type="button" onClick={props.proceed} className="custom-btn" style={{ width: "auto" }}>
                                    Save And Proceed
